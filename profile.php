...
<div class="pf-shell container-site mt-5">
    ...
    <aside class="pf-side card-glass">
        ...
        <div class="pf-side-head">
            <div class="pf-avatar" aria-hidden="true"><?= htmlspecialchars($initials, ENT_QUOTES, 'UTF-8') ?></div>
            <div class="pf-side-id">
                <strong class="pf-side-name"><?= htmlspecialchars($_SESSION['user']['name'], ENT_QUOTES, 'UTF-8') ?></strong>
                <span class="pf-side-mobile"><?= htmlspecialchars($_SESSION['user']['mobile'], ENT_QUOTES, 'UTF-8') ?></span>
            </div>
        </div>
        ...
        <nav class="pf-nav" role="tablist" aria-label="بخش‌های پروفایل">
            ...
            <button class="pf-nav-item is-active" data-tab="overview" role="tab" aria-selected="true">
                <i class="fa-solid fa-gauge-high"></i>
                <span>نمای کلی</span>
            </button>

            <button class="pf-nav-item" data-tab="orders" role="tab" aria-selected="false">
            ...
            <button class="pf-nav-item" data-tab="messages" role="tab" aria-selected="false">
            ...
            <button class="pf-nav-item" data-tab="personal" role="tab" aria-selected="false">
                <i class="fa-solid fa-id-card"></i>
                <span>اطلاعات شخصی</span>
            </button>

            <button class="pf-nav-item" data-tab="security" role="tab" aria-selected="false">
