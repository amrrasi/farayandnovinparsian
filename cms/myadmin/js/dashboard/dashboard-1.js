		...
		var widgetChart1 = function () {
			if (jQuery('#widgetChart1').length > 0) {
				...
				new Chart(chart_widget_1, {
					type: "line",
					data: {
						labels: ["فروردین", "اردیبهشت", "خرداد", "تیر", "مرداد", "شهریور", "مهر", "آبان", "آذر", "دی", "بهمن", "اسفد"],
		...
		var widgetChart2 = function () {
			if (jQuery('#widgetChart2').length > 0) {
				...
				new Chart(chart_widget_2, {
					type: "line",
					data: {
						labels: ["فروردین", "اردیبهشت", "خرداد", "تیر", "مرداد", "شهریور", "مهر", "آبان", "آذر", "دی", "بهمن", "اسفد", "فروردین", "اردیبهشت", "خرداد", "تیر", "مرداد", "شهریور", "مهر", "آبان", "آذر", "دی", "بهمن", "اسفد"],
